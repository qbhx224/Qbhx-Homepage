  ...
  <section id="about" class="hero">
    ...
    <div class="hero-content">
      ...
      <div class="social-links">
        ...
        <a href="https://blog.qbhx123.top" target="_blank" rel="noopener noreferrer" class="social-btn">
